...
#define PRESET_WIFI_SSID ""
#define PRESET_WIFI_PASS ""
#define PRESET_CITY ""
#define PRESET_ADM ""
#define KEY "747150b92e714f5d88f3d6b0ce94c5ff"
#define QW_API_HOST "https://p95vxp7xde.re.qweatherapi.com"
...
const String airURL = String(QW_API_HOST) + "/airquality/v1/current/"; // 空气质量接口
...
const String ROOT_HTML_PAGE2 PROGMEM = R"rawliteral(
        ...
        <input type='text' placeholder='列表没有？在这里手动输入WiFi名称' name='custom_ssid' id='custom_ssid' class='passAndCity commonWidth'>
    ...
    <script type='text/javascript'>
        function doSubmit(){
            ...
            var customValue = document.getElementById('custom_ssid').value.trim();
